...
import 'package:project1/shared/edit_profile.dart';
...
class _UserProfileState extends State<UserProfile> {
  ...
  /*Future<dynamic> getdata() async {
    //print(widget.email);
    var url = 'http://192.168.43.75/DonorDashboard/php_files/getdata.php';
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          ListTile(
            ...
            trailing: IconButton(
              icon: Icon(FontAwesomeIcons.pencilAlt, size: 25),
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => EditProfile(type: "Name"),
                    ));
              },
            ),
          ),
